...
Public MustInherit Class Boid
    ...
    Sub Avance(ByRef a As Boid, ByVal H As Integer, ByVal L As Double, ByRef OV As Integer, ByRef OM As Integer, ByRef m As Monde, ByVal zoom As Double, ByVal position As Vecteur)

        Dim j As Integer
        Dim oeufMangé As Integer
        Dim K As Vecteur
        Dim Manger As Boolean = False
        Dim dt As Integer = Rnd() * ((CInt(Form2.lbl_vmax.Text)) - (CInt(Form2.lbl_vmin.Text))) + (CInt(Form2.lbl_vmin.Text))
